...
namespace MMBS.Model.PostForm
{
    public class PostFormGeneralCustom
    {
        ...
        public static void generateAndExport(string templatePath, string dataPath, string targetPath)
        {
            ...
            MmbsTemplateModelv1 data = System.Text.Json.JsonSerializer.Deserialize<MmbsTemplateModelv1>(File.ReadAllText(dataPath));
            //MmbsTemplateModelv1 data = System.Text.Json.JsonDocument.Decode(File.ReadAllText(dataPath), typeof(MmbsTemplateModelv1));
