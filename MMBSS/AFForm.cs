    ...
    TResult value);
        ...
        public void InfoSeterProc(string cmd)
        {
            ...
            switch (title)
            {
                ...
                case "threadsCounter.+": threadsCounter++;break;
                case "threadsCounter.-": threadsCounter--; break;
            }
        ...
        {
            String queryText = "";
            comboSourceQuery.Invoke(new System.Windows.Forms.MethodInvoker(delegate() { queryText = comboSourceQuery.Text; }));
            this.Invoke(InfoSeter,"threadsCounter.+");
            ...
            if (processDataResourceTextBox.valid==1)
            {
                ...
                groupDS.Invoke(new System.Windows.Forms.MethodInvoker(delegate { groupDS.Text = (processDataResourceTextBox.host == "play.google.com" ? DSlabelText[1] : (processDataResourceTextBox.host == "apkpure.com" ? DSlabelText[2] : DSlabelText[0])); }));
                butIcon.Invoke(new System.Windows.Forms.MethodInvoker(delegate { butIcon.Image = processDataResourceTextBox.coverImageDir == "default" ? Properties.Resources.offlinemods_logo_pns : AFFinputer.appInfo.icon.image; }));
       ...
       // [STAThread]
        public void boxDLproc()
        {
            ...
            this.Invoke(InfoSeterDown,"threadsCounter.+");
            ...
            labelValidDL.Invoke(new System.Windows.Forms.MethodInvoker( delegate { labelValidDL.Visible = processDownloadLinkTextBox.valid == 1; }));
            labelUnvalidDL.Invoke(new System.Windows.Forms.MethodInvoker(delegate { labelUnvalidDL.Visible = processDownloadLinkTextBox.valid == 2; }));
            linkDLname.Invoke(new System.Windows.Forms.MethodInvoker(delegate { linkDLname.Text = processDownloadLinkTextBox.fname; }));
        ...
        public void boxAOproc()
        {
           ...
           /* this.Invoke(InfoSeter, "checkAO label\n" + processAPKLinkTextBox.valid);
            ...
            labelValidAO.Invoke(new System.Windows.Forms.MethodInvoker(delegate { labelValidAO.Visible = processAPKLinkTextBox.valid == 1; }));
            labelUnvalidAO.Invoke(new System.Windows.Forms.MethodInvoker(delegate { labelUnvalidAO.Visible = processAPKLinkTextBox.valid == 2; }));
            linkAOname.Invoke(new System.Windows.Forms.MethodInvoker(delegate { linkAOname.Text = processAPKLinkTextBox.fname; }));
            this.Invoke(InfoSeterDown, "threadsCounter.-");
        }
        ...
        public void boxMirrorDLproc()
        {
            ...
            labelValidMirrorDL.Invoke(new System.Windows.Forms.MethodInvoker(delegate { labelValidMirrorDL.Visible = processMirrorLinkTextBox.valid == 1; }));
            labelUnvalidMirrorDL.Invoke(new System.Windows.Forms.MethodInvoker(delegate { labelUnvalidMirrorDL.Visible = processMirrorLinkTextBox.valid == 2; }));
            linkMirrorDownload.Invoke(new System.Windows.Forms.MethodInvoker(delegate { linkMirrorDownload.Text = processMirrorLinkTextBox.fname; }));
            this.Invoke(InfoSeterDown, "threadsCounter.-");
        }
