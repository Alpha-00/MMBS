...
namespace MMBS
{
    public partial class FMForm : Form
    {
        ...
        public void LoadDataFromPostDataBundleToForm(PostDataBundle thenow)
        {
            ...
            this.boxAPKlink.Text = thenow.Downloadlink.APKlink.link;
            this.labelAPKlink.Text = thenow.Downloadlink.APKlink.linkalias;
        ...
        {
            FormData.Downloadlink.APKlink.link = boxAPKlink.Text;
            FormData.Downloadlink.APKlink.Check();
            if (!checkAPKLink.Checked && FormData.Downloadlink.APKlink.legal) checkAPKLink.Checked = true;
        }
        ...
        {
            FormData.Downloadlink.APKlink.check = checkAPKLink.Checked;
        }
        ...
        private void butMAPK_Click(object sender, EventArgs e)
        {
            ...
            if (FormData.Downloadlink.linklist.Count == 1) FormData.Downloadlink.linklist.Add(new DefineInfoPack.Linker("apk"));
